    <tr align="center">
      ...
      <td><input class="numerical_input" type="text" name="X0" size="10" value="<?php echo isset($X[0])?$Y[0]:null; ?>" onkeyup="comma_block(this)"></td>
    </tr>
    <tr align="center">
      <td></td> <td></td>
      <td><input class="numerical_input" type="text" name="azimuth0" size="10" value="<?php echo isset($azimuth[0])?$azimuth[0]:null; ?>" onkeyup="comma_block(this)"></td>
...
?>
    <tr align="center">
      <td><input type="text" name="id<?php echo $i; ?>" size="4" value="<?php echo isset($id[$i])?$id[$i]:null; ?>"></td>
      <td><input class="numerical_input" type="text" name="angle<?php echo $i; ?>" size="10" value="<?php echo isset($angle[$i])?$angle[$i]:null; ?>" onkeyup="comma_block(this)"></td>
    ...
    <tr align="center">
      ...
      <td><input class="numerical_input" type="text" name="distance<?php echo $i; ?>" size="10" value="<?php echo isset($distance[$i])?$distance[$i]:null; ?>" onkeyup="comma_block(this)"></td>
